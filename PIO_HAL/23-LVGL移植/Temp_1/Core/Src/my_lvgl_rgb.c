...
static lv_style_t style_r,style_g,style_b;
 lv_obj_t* my_lvgl_rgb(void)//��ں���
{
	/****************************************************************************************************************
	*����
	*
	****************************************************************************************************************/
    ...
    lv_led_set_color(led, lv_color_make(255,255,255));
		...
		lv_obj_set_style_bg_color(my_obj_rgb,lv_color_hex(0x000000),0);
		return my_obj_rgb;
}
...
static void slider_event_cb(lv_event_t * e)
{
	...
	uint8_t r,g,b;
		...
		lv_led_set_color(led, lv_color_make(r,g,b));//������Ļ��
		//ry_set_rgb(r,g,b);//���ÿ�����RGB��
}
