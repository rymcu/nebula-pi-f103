...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (24 * 1024U)          /*[bytes]*/  //RYMCU
...
#define LV_DEF_REFR_PERIOD  10      /*[ms]*/ //33 RYMCU

/*Default Dot Per Inch. Used to initialize default sizes such as widgets sized, style paddings.
 *(Not so important, you can adjust it to modify default sizes and spaces)*/
#define LV_DPI_DEF 99 //130     /*[px/inch]*/ //= ((¡Ì320*240) / 2.8) ¡Ö 99 RYMCU
...
#define LV_USE_LOG 1 //RYMCU
    ...
    *LV_LOG_LEVEL_NONE        Do not log anything*/
    #define LV_LOG_LEVEL LV_LOG_LEVEL_ERROR //RYMCU

    /*1: Print the log with 'printf';
    *0: User need to register a callback with `lv_log_register_print_cb()`*/
    #define LV_LOG_PRINTF 0 //RYMCU
...
#define LV_USE_SYSMON   1 //RYMCU
    ...
    #define LV_USE_PERF_MONITOR 1 //RYMCU
